...
For the user-facing rate limiting guide (behavior, configuration, tuning), see [Rate Limiting](/docs/guides/rate-limiting).
...
|----------|-------------|
| [Rate Limiting](/docs/guides/rate-limiting) | User-facing rate limiting guide |
| [System Overview](/docs/internal/system-overview) | Full system architecture |
