...
<Callout type="info">
The snippet above is intentionally minimal. The [`examples/nextjs`](https://github.com/EricTsai83/optstuff/tree/HEAD/examples/nextjs) project includes a **hardened version** with input validation, query-string encoding, and allowed-format whitelists — use it as a starting point for production.
</Callout>
