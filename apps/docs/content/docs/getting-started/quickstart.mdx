...
If you want to confirm your keys and configuration before integrating into your app, you can use the standalone CLI tool at [`examples/optstuff-url-signer`](https://github.com/EricTsai83/optstuff/tree/HEAD/examples/optstuff-url-signer):
...
<FrameworkGrid>
  <FrameworkCard
    ...
    href="/getting-started/integrate-nextjs"
  />
</FrameworkGrid>
