...
This guide walks you through creating a project and obtaining your API keys. Once set up, you can either verify your configuration with a quick CLI test or jump straight into a framework integration.
...
<Cards>
  <Card title="Sign Your First URL" href="/getting-started/sign-your-first-url">
    Verify your setup in 2 minutes with a standalone CLI tool — no framework needed.
  </Card>
  <Card title="Next.js Integration" href="/getting-started/integrate-nextjs">
    Integrate OptStuff into a Next.js app with Server Components, API Routes, and the next/image loader.
  </Card>
</Cards>
