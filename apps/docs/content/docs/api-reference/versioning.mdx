...
1. **Announcement** — The new version is announced in the [Changelog](/docs/changelog) with a migration guide
...
- [Changelog](/docs/changelog) — Release notes and version announcements
- [API Endpoint](/docs/api-reference/endpoint) — Current endpoint format
- [URL Signing](/docs/guides/url-signing) — Signature formula for the current version
