...
This page is the complete reference for the OptStuff image optimization API endpoint. For a step-by-step integration tutorial, see the [Integration Guide](/docs/getting-started/integration-guide).
...
| `sig` | Yes | HMAC-SHA256 signature (see [URL Signing](/docs/guides/url-signing)) |
...
For the full error reference, see [Error Codes](/docs/api-reference/error-codes).
...
- [Error Codes](/docs/api-reference/error-codes) — Complete error reference with troubleshooting
- [URL Signing](/docs/guides/url-signing) — How to generate signatures
- [Integration Guide](/docs/getting-started/integration-guide) — Step-by-step integration
