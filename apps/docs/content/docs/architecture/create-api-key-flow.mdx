...
description: Architecture documentation — API key creation flow, dual-key system, AES-256-GCM encryption, form validation, and database schema.
---
...
```mermaid title="Create API key flow"
flowchart TD
...
- [Domain Whitelisting](/guides/domain-whitelisting) — Settings → Domain Security
- [Security Best Practices](/guides/security-best-practices) — Key management recommendations
- [Control Plane and Multi-Tenancy](/architecture/control-plane-and-tenancy) — How key lifecycle fits tenancy and access control
- [What is OptStuff?](/docs) — Service overview
