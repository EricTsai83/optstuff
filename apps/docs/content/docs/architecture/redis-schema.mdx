...
|----------|-------------|
| [How OptStuff Is Built](/architecture/how-optstuff-is-built) | Recommended architecture reading path |
...
| [System Overview](/architecture/system-overview) | Full system architecture |
