...
description: Architecture reference for OptStuff — components, request pipelines, data stores, and operational behavior.
---
...
For the full Architecture reading path, start with [How OptStuff Is Built](/architecture/how-optstuff-is-built).
...
- [How OptStuff Is Built](/architecture/how-optstuff-is-built)
- [API Endpoint](/api-reference/endpoint)
- [Request Lifecycle](/architecture/request-lifecycle)
- [Control Plane and Multi-Tenancy](/architecture/control-plane-and-tenancy)
...
- [SSRF Prevention](/architecture/ssrf-prevention)
