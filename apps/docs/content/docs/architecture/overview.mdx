...
5. [Usage Metrics Calculations](/architecture/usage-metrics-calculations) — Exact formulas, data sources, and sampling caveats for analytics.
6. [Redis Schema](/architecture/redis-schema) — Cache-aside, rate-limit counters, and write throttling.
7. [SSRF Prevention](/architecture/ssrf-prevention) — Threat model and redirect-handling invariant.
