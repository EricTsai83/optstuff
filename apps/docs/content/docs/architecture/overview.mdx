...
5. [Redis Schema](/architecture/redis-schema) — Cache-aside, rate-limit counters, and write throttling.
6. [SSRF Prevention](/architecture/ssrf-prevention) — Threat model and redirect-handling invariant.
