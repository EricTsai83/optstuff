...
|-------|------------------|
| [**Signed URLs, HMAC-SHA256**](/guides/url-signing) | Prevents unauthorized URL forging |
| [**Source domain allowlist**](/guides/domain-whitelisting) | Controls which image origins can be fetched |
| [**Referer allowlist**](/guides/referer-security-model) | Mitigates browser hotlinking |
| [**Key expiry / revocation**](/guides/key-management) | Invalidates stale or compromised credentials |
| [**Rate limiting**](/guides/rate-limiting) | Limits abuse and accidental bursts |
