...
OptStuff offers a free plan with 10,000 requests and 1 GB bandwidth per month. For details on all plans, limits, and what happens when you exceed them, see [Pricing and Limits](/docs/introduction/pricing-and-limits).

## Next Steps

- **New to OptStuff?** Start with [Core Concepts](/docs/introduction/core-concepts) to understand the key building blocks.
- **Ready to integrate?** Jump to the [Quick Start](/docs/getting-started/quickstart) for a 5-minute walkthrough.
