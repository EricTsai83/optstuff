...
| Service | Cost per 1K Optimizations |
|---------|--------------------------|
| **Cloudinary** (free tier) | $0 (up to 25K/mo), then ~$0.45 per 1K |
| **imgix** | ~$3.00 per 1K (rendering) |
| **Vercel Image Optimization** | ~$5.00 per 1K (at $5/1K source images) |
| **OptStuff (self-hosted, 100K/mo)** | ~$0.72 per 1K |
| **OptStuff (self-hosted, 1M/mo)** | ~$0.10 per 1K |
