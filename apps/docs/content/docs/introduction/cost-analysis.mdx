...
| Item | Value |
|------|-------|
| Price | $0.60 per 1M invocations |
| Free tier (Hobby/Pro) | First 1M/month included |
| **Per-request cost** | **$0.0000006** |
...
| Item | Value |
|------|-------|
| Rate (US region) | ~$0.128 per CPU-hour |
| Typical image transform | 50–200ms CPU time |
| Estimate at 100ms | $0.128 / 3,600 × 0.1 = **$0.0000036** |
...
| Item | Value |
|------|-------|
| Rate (US region) | ~$0.0106 per GB-hour |
| Function memory | ~256MB (0.25 GB) |
| Instance lifetime | ~300ms (including I/O) |
| Cost | 0.25 × (0.3 / 3,600) × $0.0106 = **$0.0000002** |
...
| Item | Value |
|------|-------|
| Rate | $0.20 per 100K commands |
| Commands per request | ~4 |
| **Per-request cost** | 4 × $0.000002 = **$0.000008** |
...
| Item | Value |
|------|-------|
| Pro plan included | 1 TB/month |
| Overage rate | $0.15 per GB |
| Average optimized image | ~80–150 KB |
| Estimate at 100 KB | $0.15 / 1,000,000 × 100 = **$0.000015** |
...
|-----------|-----------------|------------|
| Vercel CPU | $0.0000036 | 13% |
| Vercel Bandwidth | $0.0000150 | 55% |
| Upstash Redis | $0.0000080 | 29% |
| Neon PostgreSQL | $0.0000010 | 4% |
| Vercel Invocation | $0.0000006 | 2% |
| Vercel Memory | $0.0000002 | 1% |
| **Total** | **~$0.0000274** | 100% |
...
|--------|--------------|
| 1,000 requests | ~$0.03 |
| 10,000 requests | ~$0.27 |
| 100,000 requests | ~$2.74 |
| 1,000,000 requests | ~$27.40 |
...
|----------------|------------|----------------------|
| 10,000 | $0 + $0.27 = **$0.27** | $69 + $0.27 = **$69.27** |
| 100,000 | $0 + $2.74 = **$2.74** | $69 + $2.74 = **$71.74** |
| 1,000,000 | Over free limits | $69 + $27.40 = **$96.40** |
...
1. **Bandwidth is the largest variable cost** (~55% per request) — CDN caching is your best cost optimization lever
