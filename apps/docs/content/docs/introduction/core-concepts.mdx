...
App Server                              OptStuff
┌─────────────────────────────────┐     ┌───────────────────────────────────┐
│ 1) Build transformation payload │     │ 4) Resolve project + key          │
│ 2) Sign payload with sk_...     │ ──> │ 5) Verify signature and policies  │
│ 3) Return signed URL to client  │     │ 6) Fetch, transform, return       │
└─────────────────────────────────┘     └───────────────────────────────────┘
```
