...
For the signing formula, see [URL Signing](/guides/url-signing). For a complete Next.js integration, see the [Next.js Integration Guide](/getting-started/integrate-nextjs).
