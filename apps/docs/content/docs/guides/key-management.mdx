...
```mermaid title="API key lifecycle states"
stateDiagram-v2
  [*] --> Active: Create key
...
1. Create a key from the dashboard (see [Quick Start](/getting-started/quickstart))
...
- [Quick Start](/getting-started/quickstart) — How to create and manage keys in the UI
