...
```mermaid title="Layered security model"
flowchart TD
...
- [Domain Whitelisting](/guides/domain-whitelisting) — Configure referer and source domain allowlists (both project-level)
