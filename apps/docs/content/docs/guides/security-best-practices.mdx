...
Two-layer domain control restricts both who can use the service (referer domains) and which images can be processed (source domains). See [Domain Whitelisting](/guides/domain-whitelisting) for configuration.
