...
```text
GET https://images.example.com/api/v1/my-blog/w_800,q_80,f_webp/cdn.example.com/photo.jpg?key=pk_...&sig=...&exp=1706500000
```
...
<Cards>
  ...
  <Card title="Integration Guide" href="/getting-started/integration-guide">
    Add OptStuff to your Next.js or TypeScript application with signed URLs.
  </Card>
